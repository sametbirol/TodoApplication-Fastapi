...
SECRET_KEY = "YwtwBpuHrmp8CfDtaDMRqyUcn28mG4ka"
ALGORITHM = "HS256"
...
async def register(request:Request,email:str=Form(),username:str=Form(),firstname:str=Form(),lastname:str=Form(),password:str=Form(),password2:str=Form(),db:Session=Depends(get_db)):
